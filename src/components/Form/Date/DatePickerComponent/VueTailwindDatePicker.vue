...
function datepickerClasses(date: DatePickerDay) {
  ...
  if (active) {
    if (disabled) {
      ...
      classes = 'tc-text-vtd-secondary-700 tc-font-medium dark:tc-text-vtd-secondary-100 tc-rounded-full'
    } else {
      classes = 'tc-text-vtd-secondary-600 tc-font-medium dark:tc-text-vtd-secondary-200 tc-rounded-full'
    }
  }

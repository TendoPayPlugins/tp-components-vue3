    ...
    >
        ...
        >
            <li v-for="(item, i) in withShortcut" :key="i">
                <a
                        href="#"
                        class="tc-vtd-shortcuts tc-block tc-text-sm lg:tc-text-xs tc-px-2 tc-py-2 sm:tc-leading-4 tc-whitespace-nowrap tc-font-medium tc-rounded tc-text-vtd-primary-600 hover:tc-text-vtd-primary-700 tc-transition-colors hover:tc-bg-vtd-secondary-100 focus:tc-bg-vtd-secondary-100 focus:tc-text-vtd-primary-600 dark:hover:tc-bg-vtd-secondary-700 dark:hover:tc-text-vtd-primary-300 dark:tc-text-vtd-primary-400 dark:focus:tc-bg-vtd-secondary-700 dark:focus:tc-text-vtd-primary-300"

      ...
      <div>
        ...
        >
          ...
          <a
            href="#"
            aria-current="page"
            class="relative z-10 inline-flex items-center bg-tp-primary px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-tp-primary"
          >1</a>
          <a
            href="#"
